                        ...
                        return (
                            <div key={index} className='contentBox' style={{position: 'relative'}}>
                                ...
                                <div className='otherInfo'>
                                    <div className='user'>
                                        <LazyLoad offset={100}>
                                            <img src={userList.img ? userList.img[0].url.substring(0, 4) === 'http' ? userList.img[0].url : require('@/' + userList.img[0].url) : require('@/statics/img/blank.jpeg')} className='avatar' alt=""/>
                                        </LazyLoad>
                        ...
                        return (
                            <div key={index} className='contentBox' style={{position: 'relative'}}>
                                ...
                                <div className='otherInfo'>
                                    <div className='user'>
                                        <LazyLoad offset={100}>
                                            <img src={userList.img[0].url.substring(0, 4) === 'http' ? userList.img[0].url : require('@/' + userList.img[0].url)}className='avatar' alt=""/>
                                        </LazyLoad>
                                        <span className='userName'>{userList.name}</span>
                                    </div>
                                    <div className='collection'>
